...
@property(nonatomic, strong) NSDate *firstDateOfCalendar;
@property(nonatomic, strong) NSDate *lastDateOfCalendar;
- (void) monthForward;
- (void) monthBack;
...
//Dot functionality.......
@property NSUInteger aMonth;
@property NSUInteger aYear;
@property NSUInteger aDay;
