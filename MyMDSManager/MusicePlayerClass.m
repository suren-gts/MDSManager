...
@interface MusicePlayerClass ()<AVAudioPlayerDelegate>
...
@implementation MusicePlayerClass
...
- (void)configureAudioPlayer:(NSString *)strMusiceName
{
    ...
    NSString *backgroundMusicPath = [[NSBundle mainBundle] pathForResource:strMusiceName ofType:@"mp3"];
