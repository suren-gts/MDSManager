...
- (NSDate *) dateByAddingMinutess: (NSInteger) dMinutes
{
...
-(NSDate*)startDateOfCurrentWeek
{
	...
	int dayofweek = [[[NSCalendar currentCalendar] components:NSWeekdayCalendarUnit fromDate:self] weekday];// this will give you current day of week
...
-(NSDate*)endDateOfCurrentWeek
{
	...
	int Enddayofweek = [[[NSCalendar currentCalendar] components:NSWeekdayCalendarUnit fromDate:self] weekday];// this will give you current day of week
...
-(NSString*)dateOfWeekDay:(int)day
{
	...
	if (day==1) //start day
	{
		return [dateFormat stringFromDate:[self startDateOfCurrentWeek] ];
	}
	else if (day==7) //end day
	{
		return [dateFormat stringFromDate:[self endDateOfCurrentWeek]];
	}
	else
	{
		NSDate *startDate=[self startDateOfCurrentWeek];
		
		return [dateFormat stringFromDate:[startDate dateByAddingDays:day-1]];
	}
}
...
- (NSDate *) dateBySubtractingMonths: (NSInteger) monthsToAdd
{
	NSCalendar * calendar = [NSCalendar currentCalendar];
